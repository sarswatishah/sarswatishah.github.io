  ...
  <div class="row">
    ...
    <div class="col-lg-8 col-xl-9">
      ...
      <div style="margin-top:0%; text-align:justify;">
        <p>Currently, I am working as a DGAPA postdoctoral fellow in the 
        <a href="https://www.matem.unam.mx/" style="color:black" target="_blank">Institute of Mathematics (IM)</a>, at the
        <a href="https://www.unam.mx/" style="color:black" target="_blank">National Autonomous University of Mexico (UNAM)</a>,
        working with
        <a href="https://paginas.matem.unam.mx/gerardo/" style="color:black" target="_blank">Prof. Gerardo Hernandez Dueñas</a>.
         I obtained my Ph.D. degree from the
        <a href="https://www.pku.edu.cn/" style="color:black" target="_blank">Department of Mathematics</a>, at the
        in <a href="https://www.math.pku.edu.cn/" style="color:black" target="_blank">University of Delhi,</a>,
        under the supervision of  <a href="https://www.researchgate.net/profile/Randheer-Singh-4" style="color:black" target="_blank">Prof. Randheer Singh</a>.
        My research interests are focused on the theoretical and numerical aspects of non-linear hyperbolic partial differential
      equations
        </p>
      </div>
